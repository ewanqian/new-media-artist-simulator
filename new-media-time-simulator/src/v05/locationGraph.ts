...
export const spatialRegions: SpatialRegion[] = [
  {
    ...
    facilityIds: ['shared-studio', 'river-diner', 'loading-dock'],
    tags: ['studio', 'peer', 'survival']
  },
  {
    id: 'region-shenzhen',
    name: '深港加速走廊',
    ...
    facilityIds: ['pitch-room', 'black-box', 'production-yard'],
    tags: ['commercial', 'live', 'production']
  },
  {
    id: 'region-academy',
    name: '南岭学院与展厅群',
    ...
    facilityIds: ['lecture-hall', 'gallery', 'open-call-office'],
  ...
  },
  {
    ...
    facilityIds: ['hangar', 'media-desk', 'production-office'],
    tags: ['institution', 'space', 'global']
  },
  {
    id: 'region-residency',
    name: '海外驻留港',
    ...
    facilityIds: ['residency-lab', 'border-cafe', 'project-room'],
    tags: ['global', 'residency', 'research']
  }
];
...
export const specialistServices: SpecialistService[] = [
  {
    id: 'compute-rack',
    name: '远程算力节点',
    description: '需要重型实时图形、重建或大规模输出时才出现。',
    functions: ['compute', 'render'],
    relevantPracticeIds: ['systems-generative', 'spatial-installation', 'live-performance', 'image-capture']
  },
  {
    id: 'preview-node',
    name: '离线预演节点',
    description: '把高成本运行先转换成低成本代理测试。',
    functions: ['preview', 'proxy'],
    relevantPracticeIds: ['systems-generative', 'spatial-installation', 'live-performance', 'image-capture']
  },
  {
    id: 'recovery-bay',
    name: '数据恢复服务',
    description: '项目确实出现损坏或丢失状态后才进入可用列表。',
    functions: ['recovery', 'archive'],
    relevantPracticeIds: ['systems-generative', 'spatial-installation', 'live-performance', 'image-capture', 'production-commission']
  }
];
